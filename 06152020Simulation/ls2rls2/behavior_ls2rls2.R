...
for (i in 1: length(lambda.seq)) {
  ...
  png(paste0("plot-B-ls-ls2rls2-wocT-gamma2.png"))
  plot(B2, t(B_iter)[,-1])
  abline(a = 0, b = 1)
  dev.off()
  
  # save image for XB matrix
  png(paste0("plot-XB-ls-ls2rls2-wocT-gamma2.png"))
  plot(B2 %*% X2, t(B_iter)[,-1] %*% X2)
  abline(a = 0, b = 1)
  dev.off()
  
  # save image for T matrix
  png(paste0("plot-T-ls-ls2rls2-wocT-gamma2.png"))
  plot(T, T_iter)
  abline(a = 0, b = 1)
  dev.off()
  
  # save image for T matrix
  png(paste0("plot-beta-ls-ls2rls2-wocT-gamma2.png"))
  plot(b, t(B_iter)[,1])
  abline(a = 0, b = 1)
  dev.off()
  
  # save image for Z matrix
  png(paste0("plot-Z-ls-ls2rls2-wocT-gamma2.png"))
  plot(Z, Z.est)
  abline(a = 0, b = 1)
  dev.off()
}
