...
for (j in 1:10) {
  ...
  for (i in 1: length(lambda.seq)) {
    ...
    # Z_iter_b <- Z_v - X2_v %*% B_iter - matrix(rep(T_iter, each = k), nrow = 10, byrow = T)
    # b_iter_next <- matrix(colMeans(Z_iter_b), nrow = 1)
...
# png(paste0("plot-B-rls3-wocT.png"))
# plot(B2, B_iter)
# abline(a = 0, b = 1)
# dev.off()
# 
# # save image for XB matrix
# png(paste0("plot-XB-rls3-wocT.png"))
# plot(X2 %*% B2,  X2 %*% B_iter)
# abline(a = 0, b = 1)
# dev.off()
# 
# # save image for T matrix
# png(paste0("plot-T-rls3-wocT.png"))
# plot(T, T_iter)
# abline(a = 0, b = 1)
# dev.off()
# 
# # save image for T matrix
# png(paste0("plot-beta-rls3-wocT.png"))
# plot(b, b_iter)
# abline(a = 0, b = 1)
# dev.off()
# 
# # save image for Z matrix
# png(paste0("plot-Z-rls3-wocT.png"))
# plot(Z, Z.est)
# abline(a = 0, b = 1)
# dev.off()
