...
for (i in 1: length(lambda.seq)) {
  ...
  png(paste0("plot-B-ls-3steps.png"))
  plot(B, t(B_iter))
  abline(a = 0, b = 1)
  dev.off()

  # save image for XB matrix
  png(paste0("plot-XB-ls-3setps.png"))
  plot(B %*% X, t(B_iter) %*% X)
  abline(a = 0, b = 1)
  dev.off()

  # save image for T matrix
  png(paste0("plot-T-ls-3steps.png"))
  plot(T, T_iter)
  abline(a = 0, b = 1)
  dev.off()

  # save image for T matrix
  png(paste0("plot-beta-ls-3steps.png"))
  plot(b, b_iter)
  abline(a = 0, b = 1)
  dev.off()

  # save image for Z matrix
  png(paste0("plot-Z-ls-3steps.png"))
  plot(Z, Z.est)
  abline(a = 0, b = 1)
  dev.off()
}
...
for (i in 1: length(lambda.seq)) {
  ...
  # save image for B matrix
  png(paste0("plot-B-rls-3steps.png"))
  plot(B, t(B_iter))
  abline(a = 0, b = 1)
  dev.off()

  # save image for XB matrix
  png(paste0("plot-XB-rls-3setps.png"))
  plot(B %*% X, t(B_iter) %*% X)
  abline(a = 0, b = 1)
  dev.off()

  # save image for T matrix
  png(paste0("plot-T-rls-3steps.png"))
  plot(T, T_iter)
  abline(a = 0, b = 1)
  dev.off()

  # save image for T matrix
  png(paste0("plot-beta-rls-3steps.png"))
  plot(b, b_iter)
  abline(a = 0, b = 1)
  dev.off()

  # save image for Z matrix
  png(paste0("plot-Z-rls-3steps.png"))
  plot(Z, Z.est)
  abline(a = 0, b = 1)
  dev.off()
}
