...
for (i in 1: length(lambda.seq)) {
  ...
  png(paste0("plot-B-nointercept", i, ".png"))
  plot(B, B_iter)
  dev.off()
  
  # save image for T matrix
  png(paste0("plot-T-nointercept", i, ".png"))
  plot(T, T_iter)
  dev.off()
  
  # save image for XB matrix
  png(paste0("plot-XB-nointercept", i, ".png"))
  plot(B %*% X, t(B_iter) %*% X)
  dev.off()
  
  # save image for Z matrix
  png(paste0("plot-Z-noitercept", i, ".png"))
  plot(Z, Z.est)
  dev.off()
}