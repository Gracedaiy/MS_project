...
# B.mean <- matrix(rep(rowMeans(B), each = m), ncol = m, byrow = T)
# B <- B - B.mean
...
for (i in 1: length(lambda.seq)) {
  ...
  # png(paste0("plot-B-RMBc2.png"))
  # plot(B, t(B_iter))
  # dev.off()
  # 
  # # save image for T matrix
  # png(paste0("plot-T-RMBc2.png"))
  # plot(T, T_iter)
  # abline(a = 0, b = 1)
  # dev.off()
  # 
  # # save image for XB matrix
  # png(paste0("plot-XB-RMBc2.png"))
  # plot(B %*% X, t(B_iter) %*% X)
  # abline(a = 0, b = 1)
  # dev.off()
  # 
  # # save image for Z matrix
  # png(paste0("plot-Z-RMBc2.png"))
  # plot(Z, Z.est)
  # abline(a = 0, b = 1)
  # dev.off()
}
